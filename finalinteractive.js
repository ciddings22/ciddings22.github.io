...
function plus() {
	...
	if (count == 4) {
		...
		info.innerHTML = "The Battle at Garden's Gate is Greta Van Fleet's second and most recent release. It was released on April 16, 2021. It was inspired by the band's seeing the world through touring."
	}
}
function minus() {
	if (count >= 1) {
